describe("CoP QA XXL", () => {
  ...
  it("Cypress level 1 - Text is present", () => {
    ...
    cy.contains(
      "Are you ready to become part of this special community now"
    ).should("exist");
  ...
  it("Cypress level 1 - Text is matching regular expression", () => {
    ...
    cy.contains(/20[0-9]+ Daimler Buses AG. All rights reserved./)
      .scrollIntoView()
      .should("be.visible");
  });
  ...
  it("Cypress level 2 - Validate an image element", () => {
    ...
    cy.get(".hero-image-component").each(($heroImage) => {
      cy.wrap($heroImage)
        .scrollIntoView()
  ...
  it("Cypress level 3 - Validate header navigation", () => {
    ...
    cy.get(".wb-header__inner").should("have.css", "max-width", "1440px");
  ...
  it("Cypress level 4 - Validate flyout navigation", () => {
    ...
    cy.get(".wb-flyout-menu__item-headline").contains("eActros");
    cy.get(".wb-flyout-menu__item-headline").contains("eEconic");
